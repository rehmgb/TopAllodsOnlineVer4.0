...
<div ng-include="&#39;partials/rating_selector.html&#39;" ng-controller="rating_selector" class="ng-scope"><div class="ratings__selector ng-scope">
   <a href="/top/index.php?" class="ratings__button--alley">Аллея славы</a>
	...
	<a href="/top/index.php?option=guild" class="ratings__button ratings__button--guilds active" ng-class="{active:active == \'guild\'}">Гильдии</a>
    ...
    <tr>
	 <th ts-criteria="fraction" class="tablesort-sortable"><span>&#9650;</span></th>
        <th ts-criteria="name|lowercase" class="tablesort-sortable"><span>Фракция</span></th>
           <th ts-criteria="class" class="tablesort-sortable"><span>Гильдия</span></th>
		   <th ts-criteria="level|parseInt" class="tablesort-sortable"><span>Персонаж</span></th>
        <th ts-criteria="race" class="tablesort-sortable"><span>Авторитет</span></th>
		<th ts-criteria="gearscore|parseInt" class="tablesort-sortable"><span>Уровень</span></th>
...
<?php $i = 0; while($row = mysql_fetch_array($result,MYSQL_ASSOC)) { $i++ ?>
					<td><?php echo $i;?></td>
						...
						<td><?php echo $row['unlocked_level']?></td></tr>
